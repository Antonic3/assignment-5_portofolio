...
export default function AboutContent() {
  return (
    <>
      <section className="p-16 sm:flex sm:flex-col sm:gap-5 lg:mx-10 xl:mx-40 xl:grid xl:grid-cols-[1fr] xl:gap-10 leading-relaxed text-lg">
        <div className="xl:grid xl:grid-cols-2 xl:gap-5 roboto-regular text-2xl">
          <Card hover={true}>
            <h3 className="roboto-bold">1</h3>
            <p className="mt-3">Years of experience</p>
          </Card>
          <Card hover={true}>
            <h3 className="roboto-bold">50+</h3>
          ...
          <Card hover={true}>
            <h3 className="roboto-bold">40+</h3>
            <p className="mt-3">Company</p>
          </Card>
        </div>
        <div className="text-justify roboto-regular mt-10">
          <h2 className=" text-[#030255] playfair-display-bold text-center mt-10 text-xl">
            About me
          </h2>
          <p className="text-[#030255]  roboto-bold">
            Quick Story About me
          </p>
          <p className="mt-5">
            Hello! I’m Antoni Carla, a dedicated Fullstack web developer
          ...
          <p className="mt-5">
            My skill set includes JavaScript, React,but I&apos;m always eager to learn and adapt to new
